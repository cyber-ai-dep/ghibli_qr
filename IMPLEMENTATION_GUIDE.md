...
| `KIE_GHIBLI_MODEL` | Stage 1 model (Ghibli generation) | `qwen/image-edit` |
| `KIE_COMPOSE_MODEL` | Stage 2 model (Composition) | `seedream/4.5-edit` |
| `KIE_IMG_MODEL` | Legacy single-model fallback | (optional) |
...
**Model-aware request building** (model is passed per stage):
```python
